export const TEMPORARY_LOGS = [
  {
    _id: {
      $oid: "63dccf505e0dfd8ee8092202",
    },
    message:
    ...
    context: {
      ...
      session: "h3lpe3uingkn53ts43age45h8o",
      process: "",
      endpoint: "5170abee-aa5e-4502-8f21-9646f938b542",
      schema: "5170abee-aa5e-4502-8f21-9646f938b542",
      cronjob: "5170abee-aa5e-4502-8f21-9646f938b542",
      action: "5170abee-aa5e-4502-8f21-9646f938b542",
      mapping: "",
      user: "5170abee-aa5e-4502-8f21-9646f938b542",
      organization: "5170abee-aa5e-4502-8f21-9646f938b542",
      application: "5170abee-aa5e-4502-8f21-9646f938b542",
      host: "",
      ip: "",
    },
    level: 200,
  ...
  {
    _id: {
      $oid: "63dccf505e0dfd8ee8092204",
    },
    message:
      'Notified event "console.command" to listener "Symfony\\Bridge\\Monolog\\Handler\\ConsoleHandler::onCommand".',
    context: {
      event: "console.command",
